...
public class WalletPasswordPresenter extends BasePresenterImpl<WalletPasswordContract.View> implements WalletPasswordContract.Presenter{
    ...
    public void setPassWord(String mobile, String pay_password, String vcode, String withdraw_password) {
        String url = Constant.WALLET_PASSWORD;
